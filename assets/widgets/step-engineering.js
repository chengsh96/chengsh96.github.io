(function initStepEngineering() {
  ...
  var EN = {
    ...
    phases: [
      { icon:'◉', name:'Heel Strike', pct:'0–12%',
      ...
      { icon:'◎', name:'Mid-Stance', pct:'31–50%',
      ...
      { icon:'↺', name:'Next Heel Strike', pct:'100%→0%',
